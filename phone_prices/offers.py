...
# "6/128", "6 / 128 ГБ", "6GB/128GB", "8+256"
_RE_CFG = re.compile(r"(?<!\d)(3|4|6|8|12|16)\s*(?:гб|gb)?\s*[/+]\s*(64|128|256|512)\s*(?:гб|gb)?(?!\d)", re.I)
# "6 ГБ ... 128 ГБ" в свободной форме
_RE_CFG_LOOSE = re.compile(r"(?<!\d)(3|4|6|8|12|16)\s*(?:гб|gb)\b.*?(?<!\d)(64|128|256|512)\s*(?:гб|gb)\b", re.I | re.S)
